...
- [ ] Can we add an slash options to:
  ...
  - [ ] /stop ... Sometimes i hit enter too soon and start a command. I can use /stop to stop the last message so i can fix it and re submit it?
  - [ ] /run ... this command works perfectly, but does't show up in the telegram chat menu like the others do?
